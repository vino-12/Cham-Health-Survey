...
function valOneDigit() {
	...
	if (!x.match(regExOneDigit)) {
		...
		return false;
				...
				<!-- ====== form start ====== -->
				<form action="evaluation.php" onsubmit="return valOneDigit()" class="text-center" method="post" id="form-10">

					<div class="form-check text-start">

						<input type="text" class="form-check-input text-center" id="q10Num" name="answer" value="" checked>please enter a number
						<label class="form-check-label" for="q10Num">
						</label>
					</div>
